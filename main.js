...
for (var a = 1; a <= 10; a++) {
    var lesson = {
        name: "Lesson ".concat(a),
        status: a % 2 === 0 ? true : false
    };
    myWork.push(lesson);
}
console.log(myWork);
...
var max_value = 30;
// == 02 == //
var randomNumber = Math.floor(Math.random() * max_value) + 1;
console.log("Random number:", randomNumber);
// == 03 == //
var correctGuess = false;
// == 04 //
var guesses = [2, 8, 11, 20, 25, 30];
// == 05 == //
var i = 0;
...
console.log("Fianl Counter Value : ".concat(counter));
...
for (var collection in myObject) {
    if (myObject.hasOwnProperty(collection)) {
        console.log("Property Name : ".concat(collection, ", Property Value: ").concat(myObject[collection]));
    }
}
...
for (var i_1 = 0; i_1 < myArray.length; i_1++) {
    console.log("Index: ".concat(i_1, " , Value: ").concat(myArray[i_1]));
}
console.log("using for ... of loop : ");
for (var _i = 0, myArray_1 = myArray; _i < myArray_1.length; _i++) {
    var Value = myArray_1[_i];
    console.log("Value : ".concat(myArray));
}
